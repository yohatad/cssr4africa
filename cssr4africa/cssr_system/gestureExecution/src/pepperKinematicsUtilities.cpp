 ...
 * 
 *   This code implements the inverse kinematics for the Pepper robot arm and head chains.
 *   The inverse kinematics are used to calculate the joint angles of the arm and head chains
 *   given the 3-D position of the end-effectors of the arm and head chains.
 *   The forward kinematics are also implemented to calculate the 3-D position of the end-effectors
 *   given the joint angles of the arm and head chains.
 *   
 *   The code is based on the kinematics of the Pepper robot as described in the Pepper Technical Documentation
 ...
 *   Audit Trail
 *   -----------
 *   28 June 2024:     Completed the implementation of the inverse kinematics for the arm and head chains
