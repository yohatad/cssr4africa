...
from sound.src.ddr_node import DDRNode
from sound.src.silero_vad import SileroVad
from sound.src.speech_recorder import SpeechRecorder
from sound.src.whisper_speech_recognizer import WhisperSpeechRecognizer
from std_msgs.msg import String

# logger = logging.getLogger('hr.sound.ros_offline')

class WhipseNode(DDRNode):
    
    def __init__(self):
        # Super
        super(WhipseNode, self).__init__('/whisper_asr')

        rospy.init_node('whisper_asr')
        current_dir = os.path.dirname(os.path.realpath(__file__))
        # Default model directory
        self.model_dir= rospy.get_param('~model_dir', '/home/yoha/workspace/pepper_rob_ws/src/cssr4africa/cssr_system/sound/models')
        ...
        silero_model = os.path.join(self.model_dir,'silero_vad.onnx')
