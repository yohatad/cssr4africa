...
/***************************************************************************************************************************
   ...
   Interface to the Frame#include <gesture_execution/pepperKinematicsUtilities.h>
 and Vector classes and auxilliary friend functions required to implement a robot control program
...
void forward_kinematics_transfrom(int arm, double p_x, double p_y, double p_z, double theta_x, double theta_y, double theta_z);

Frame forward_kinematics_transformation_arms(int arm, Frame T_0, Frame T_1, Frame T_2, Frame T_3_, Frame T_3, Frame T_4, Frame T_end);

Frame DH_Transform(double a, double alpha, double d, double theta);
...
void armInverseKinematics(int arm, double p_x, double p_y, double p_z, double theta_x, double theta_y, double theta_z);
...
bool verifyJointAngles(int arm, double theta_1, double theta_2, double theta_3, double theta_4);
